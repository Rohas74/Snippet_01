...
urlpatterns = [
    ...
    path('snippets/my', views.my_snippets, name='my-list'),
    ...
    path('snippets/my-list', views.my_snippets_page, name='snippets-list-my'),
    path('regiser', views.create_user, name='register'),
